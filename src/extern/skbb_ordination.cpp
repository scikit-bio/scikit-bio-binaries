...
void skbb_center_distance_matrix_fp64(unsigned int n_dims, const double mat[], double centered[]) {
  skbb::mat_to_centered(n_dims, mat, centered);
}

void skbb_center_distance_matrix_fp32(unsigned int n_dims, const float  mat[], float  centered[]) {
  skbb::mat_to_centered(n_dims, mat, centered);
}

void skbb_center_distance_matrix_fp64_to_fp32(unsigned int n_dims, const double mat[], float  centered[]) {
  skbb::mat_to_centered(n_dims, mat, centered);
}
